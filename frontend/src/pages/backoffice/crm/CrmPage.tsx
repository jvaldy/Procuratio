      ...
      <div className="panel stack">
        ...
        {canManage && (
          <form className="row" onSubmit={onCreateRule}>
            <input placeholder="nom regle" value={ruleForm.name} onChange={(e) => setRuleForm({ ...ruleForm, name: e.target.value })} />
            ...
            <button type="button" className="btn-soft" onClick={() => runReminders().then(loadAll)}>Executer maintenant</button>
          </form>
        )}
