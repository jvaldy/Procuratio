    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-card crm-modal" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="form-grid">
          ...
          <div className="form-field"><label>Password</label><input type="password" value={createForm.password} onChange={(event) => onFormChange({ ...createForm, password: event.target.value })} placeholder="Customer2026!" /></div>
